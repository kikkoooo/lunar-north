				...
				<div class="info cf">
					<div class="inner">
						...
						<div class="social-media">
							<ul class="align-v cf">
								<li><a href="#"><?php echo file_get_contents(get_stylesheet_directory_uri().'/images/ln-social-fb.svg');?></a></li>
								<li><a href="#"><?php echo file_get_contents(get_stylesheet_directory_uri().'/images/ln-social-ig.svg');?></a></li>
							</ul>
	 					</div>
					</div>
				</div>
